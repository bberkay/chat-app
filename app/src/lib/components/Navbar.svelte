...
<nav>
    <div class="nav-items">
        <a href = "https://github.com/bberkay/sveltekit-bun-mongodb" target="_blank" aria-labelledby = "GitHub">
        ...
        <a href = "#/" onclick={toggleSidebar} id = "responsive-menu-btn" aria-labelledby = "Menu">
        ...
        <a href="/" class = {page.url.pathname === "/" || page.url.pathname.includes("messages") ? 'active' : ''} aria-labelledby = "Home">
        ...
        <a href="/profiles" class = {page.url.pathname === "/profiles" ? 'active' : ''} aria-labelledby = "Profiles">
